...
class Config {
  ...
  get absoluteSlidesEntryPointFile() {
    return path.resolve(this.absoluteRootDir, this.slidesEntryPoint);
  }
  ...
  setEnvironmentOptions() {
    return this.set({
      ...
      slidesEntryPoint: this.getEnvVar('SLIDES_ENTRY_POINT')
    });
  }
  ...
  setDefaultOptions() {
    return this.set({
      ...
      slidesEntryPoint: 'src/slides/index.js',
  ...
  validate() {
    ...
    this.validateString('slidesEntryPoint');
